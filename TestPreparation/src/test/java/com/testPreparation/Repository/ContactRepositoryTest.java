...
public class ContactRepositoryTest {
    ...
    public void setUp() throws Exception {
        ...
        repository = ContactRepositoryImpl.getInstance();
    ...
    public void read() throws Exception {
        Contact contact = repository.read("1");
        assertEquals("Thabo", contact.getSiteManager().getFirstName());
    ...
    public void update() throws Exception {
        ...
        Contact updateContact = new Contact.Builder()
                ...
                .cellphone(contactValues.get("cellphone"))
                .address(contactValues.get("address"))
                .postalCode("021")
                .build();
        repository.update(updateContact);
        contact = repository.read("1");
        assertEquals("021", contact.getPostalCode());
    }
